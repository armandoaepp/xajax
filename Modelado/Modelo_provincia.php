...
include_once 'conexion.php';
$con=new Conexion();
$consulta="Select provincia.ProvinciaId As 'ProvinciaId',provincia.ProvinciaNombre As 'Provincia',provincia.DepartamentoId As 'DepartamentoId',provincia.ubigeoProv As 'ubigeoProv' from provincia";

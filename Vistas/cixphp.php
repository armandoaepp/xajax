                ...
                for ($i = 0; $i < $numRows; $i++) {
                    ...
                    for ($z = 0; $z < $numColumns; $z++) {
                        ...
                        if (isset($data["cuerpo"][$i]["$columnas"])) {
                            if ($conta == 0) {
                                if ($pactu != "") {
                                    $tabla .= '<td><a href="#" title="Actualizar" onClick="editar('. $data["cuerpo"][$i]["$columnas"].')"  ><img   title="Actualizar" src="../img/icon-edit.png" title="Actualizar"/></a></td>';
                                }
                                if ($peli != "") {
                                    $tabla .= '<td><a href="#" onClick="eliminar('. $data["cuerpo"][$i]["$columnas"].')" ><img src="../img/icon-delete-black.png" title="Eliminar"/></a></td>';
                                }
                            }
...
function Paginar($numRows, $crxpag, $paginap, $cantlink, $orderby = -1, $buscar = "")
{
    ...
    if ($cantpag > 1) {
        ...
        $tabla .= '<div class="pagin space-min-top text-center"> <ul> ';
        if ($paginap != 1) {
